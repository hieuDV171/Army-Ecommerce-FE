...
exports.markConversationRead = exports.sendMessage = exports.getConversation = exports.getConversations = void 0;
...
const getConversations = async (req, res) => {
    ...
    try {
        ...
        for (const conv of conversations) {
            ...
            const partnerUser = await db_1.default.user.findUnique({
                where: { id: partnerId },
            ...
            const lastMsg = await db_1.default.message.findFirst({
...
const getConversation = async (req, res) => {
    ...
    const partnerId = parseInt(req.body.partner_id);
    ...
    try {
        ...
        if (isNaN(conversationId) || conversationId <= 0) {
            const existingConv = await db_1.default.conversation.findFirst({
                where: {
                    OR: [
...
const sendMessage = async (req, res) => {
    ...
    const toId = parseInt(req.body.to_id);
    const productId = parseInt(req.body.product_id) || null;
    ...
    try {
        ...
        const newMsg = await db_1.default.message.create({
            data: {
                conversation_id: conv.id,
                sender_id: userId,
                receiver_id: toId,
