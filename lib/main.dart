...
Future<void> main() async {
  ...
  try {
    ...
    logger.e('⚠️ Firebase chưa được cấu hình — push notification bị tắt: $e');
  }
  ...
  try {
    ...
    initialCustomPrimaryVal =
        prefs.getInt('theme_custom_primary') ?? 0xFF9C27B0;
    initialCustomDarkVal = prefs.getInt('theme_custom_dark') ?? 0xFF673AB7;
    initialCustomUseGradient =
        prefs.getBool('theme_custom_use_gradient') ?? true;
  } catch (_) {}
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    try {
      ...
      logger.e('⚠️ Firebase notification setup bị bỏ qua: $e');
    }
  }
      ...
      providers: [
        ...
        RepositoryProvider<FollowRepository>(
          create: (context) => FollowRepositoryImpl(
            remoteDataSource: FollowRemoteDataSource(
              dioClient: widget.dioClient,
            ),
          ),
        ),
        RepositoryProvider<BlockRepository>(
          create: (context) => BlockRepositoryImpl(
            remoteDataSource: BlockRemoteDataSource(
              dioClient: widget.dioClient,
            ),
          ),
        ),
        ...
        providers: [
          ...
          BlocProvider(
            create: (context) => PushSettingBloc(
              settingRepository: RepositoryProvider.of<SettingRepository>(
                context,
              ),
            ),
          ),
              ...
              home: BlocConsumer<AuthBloc, AuthState>(
                ...
                listener: (context, state) {
                  if (state is AuthSuccess) {
                    ...
                    try {
                      ...
                      logger.e('⚠️ Không thể đăng ký FCM token: $e');
                    }
                    ...
                    try {
                      ...
                      logger.e(
                        '⚠️ Failed to init Socket.IO in main listener: $e',
                      );
                    }
                  ...
                  if (state is AuthLogoutSuccess || state is Unauthenticated) {
                    ...
                    try {
                      ...
                      logger.e(
                        '⚠️ Failed to close Socket.IO in main listener: $e',
                      );
                    }
                  }
                  ...
                  if (state is AuthSuccess ||
                    ...
                    logger.i(
                      'ℹ️ MAIN LISTENER: State=$state — pop về root screen',
                    );
                ...
                builder: (context, state) {
                  if (state is AuthSuccess) {
                    ...
                    if (user.active == -1 &&
                        RegExp(r'^0[0-9]{9}$').hasMatch(user.username)) {
